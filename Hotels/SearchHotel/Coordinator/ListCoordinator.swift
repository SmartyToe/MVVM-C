...
class ListCoordinator: Coordinator {
    ...
    var listController:HotelListViewController?
    ...
    func setupNavigationBar()
    {
        ...
        self.pressenter.navigationBar.topItem?.title = "Hotel Finder"
    ...
    func start() {
        ...
        let listModel = HotelListModel(apiService: apiService)
        
        // model Injected to View Model
        let listViewModel = HotelListViewModel(model: listModel)
        
        // View Model inject to View Controller
        let list = HotelListViewController(viewModel: listViewModel)
